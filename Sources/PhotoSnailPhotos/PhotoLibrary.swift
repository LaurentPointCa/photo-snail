...
public enum PhotoLibrary {
    ...
    public static func requestAuth() async -> PHAuthorizationStatus {
    ...
    public struct AssetRow: Sendable {
        public let id: String
        public let creationDate: Date?
        public let mediaType: PHAssetMediaType

        public init(id: String, creationDate: Date?, mediaType: PHAssetMediaType) {
            self.id = id
    ...
    public static func listFirst(n: Int) -> [AssetRow] {
    ...
    public static func fetchAllImageAssets() -> PHFetchResult<PHAsset> {
        let opts = PHFetchOptions()
    ...
    public static func fetch(id: String) -> PHAsset? {
    ...
    public static func uuidPrefix(_ localIdentifier: String) -> String {
    ...
    public static func requestImageData(for asset: PHAsset) async throws -> (Data, CGImagePropertyOrientation) {
    ...
    public static func mediaTypeLabel(_ t: PHAssetMediaType) -> String {
        switch t {
    ...
    public static func authStatusLabel(_ s: PHAuthorizationStatus) -> String {
        switch s {
